...
powershell -NoProfile -ExecutionPolicy Bypass -Command "$desktop=[Environment]::GetFolderPath('Desktop'); $target=Join-Path $env:LOCALAPPDATA 'HonorOfHero\\honor-of-hero.exe'; $working=Join-Path $env:LOCALAPPDATA 'HonorOfHero'; $shortcut=Join-Path $desktop 'Honor of Hero.lnk'; $shell=New-Object -ComObject WScript.Shell; $link=$shell.CreateShortcut($shortcut); $link.TargetPath=$target; $link.WorkingDirectory=$working; $link.IconLocation=$target; $link.Save()"
if errorlevel 1 exit /b 1
